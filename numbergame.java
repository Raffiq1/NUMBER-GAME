...
public class numbergame {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Guess a number between 1 to 100, You will have 3 turns!" );
    ...
    if(guess==right_guess) {
      ...
      i++;
      System.out.println("Yor Guess is lower than the right guess! Turns left: "+(3-i));
      ...
      i++;
      System.out.println("Your Guess Is Higher Than THe Right Guess! Turns left: "+(3-i));
